...
export const alertVariants = tv({
  ...
  variants: {
    variant: {
      ...
      stroke: {
        root: 'bg-bg-white-0 text-text-strong-950 shadow-regular-md ring-stroke-soft-200 ring-1 ring-inset',
        closeIcon: 'text-text-strong-950 opacity-40',
      },
    },
    status: {
    ...
    size: {
      xsmall: {
        root: 'text-paragraph-xs rounded-lg p-2',
        wrapper: 'gap-2',
        icon: 'size-4',
        closeIcon: 'size-4',
      },
      small: {
        root: 'text-paragraph-sm rounded-lg px-2.5 py-2',
        wrapper: 'gap-2',
        icon: 'size-5',
        closeIcon: 'size-5',
      },
      large: {
        root: 'text-paragraph-sm rounded-xl p-3.5 pb-4',
